...
public class Leg implements Serializable {
    ...
    public Leg withStartVertex(Integer startVertex) {
        this.startVertex = startVertex;
        return this;
    }

    public Leg withEndVertex(Integer endVertex) {
        this.endVertex = endVertex;
        return this;
    }

    public Leg withMaxWeight(Double maxWeight) {
        this.maxWeight = maxWeight;
        return this;
    }

    public Leg withBasePrice(Double basePrice) {
        this.basePrice = basePrice;
        return this;
    }

    public Leg withLegType(LegType legType) {
        this.legType = legType;
        return this;
    }

    public Leg withSendTime(Integer sendTime) {
        this.sendTime = sendTime;
        return this;
    }
}
